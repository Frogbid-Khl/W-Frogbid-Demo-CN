...
<head>
    ...
    <title> Management Software - O2bd</title>
    ...
    <main class="page_content">
        ...
        <section class="page_banner text-center">
            <div class="container decoration_wrap">
                <h1 class="page_title"> Management Software Details</h1>
                <ul class="breadcrumb_nav unordered_list_center">
                    <li><a href="Home">Home</a></li>
                    <li> Management Software Details</li>
                </ul>
                ...
                <div class="details_content_wrap">
                    ...
                    <div class="section_space_lg">
                        <div class="video_widget">
                            <img src="assets/images/video/mannagement-softwear.jpg"
